...
const SocialIcons = () => {
    ...
    const darkIconColorStyle = `dark:bg-gradient-to-bl dark:from-transparent dark:to-slate-900 dark:text-slate-400 dark:before:bg-gray-700 dark:hover:text-slate-200 dark:focus:text-slate-200 dark:before:bg-gradient-to-tr dark:before:from-slate-900 dark:hover:from-slate-900 dark:hover:to-transparent `;
